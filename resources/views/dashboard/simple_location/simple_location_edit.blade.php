        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card shadow mb-4">
                    ...
                    <form class="users" action="/dashboard/manage-location/edit/{{ $simple_location->id }}" method="post">
                        @csrf
                        <div class="form-group">
                            <div class="mb-3">
                                <label for="name_location" class="form-label">name location</label>
                                <input value="{{ $simple_location->name_location }}" type="text" name="name_location" class="form-control" id="name_location" placeholder="input your name location here..">
                            </div>
                        </div>
                        <div class="form-group">
